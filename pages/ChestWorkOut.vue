  ...
  <div>
    <div
      ...
      <div class="flex justify-around">
        ...
        <div>
          <img src="images/chest.png" alt="PanCake" class="w-80 h-80 object-cover" />
        </div>
      </div>
    </div>
        ...
        <div class="container">
          ...
          <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800 py-16">
            ...
            <div class="md:w-8/12 lg:w-5/12 lg:ml-20 ">
              <h1 class=" text-3xl font-mono text-center rounded font-extrabold py-4 w-3/4 bg-teal-500 mb-7"> CHEST
                WORKOUTS</h1>
    ...
    <section class="bg-sky-100 rounded-b-3xl  w-full h-full px-16 py-6 md:col-span-2 rounded ">
    
      <!--------start---------current date and stopwatch-->
      <div class="flex justify-center py-8">
        <h1 class="text-3xl font-extrabold pt-8 font-mono ">CHEST WORKOUT VARIATION</h1>
