<template>
  <div>
    <div
      class=" h-1/4 w-full bg-indigo-300 rounded-b-3xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100 shadow-lg shadow-gray-500/50 md">
      <nuxt-link to="/Home">
      ...
      <div class="flex justify-around">
        ...
        <div>
          <img src="images/arms.png" alt="PanCake" class="w-80 h-80 object-cover" />
        </div>
      </div>
    </div>
<div>
    ...
    <div class="container">
      ...
      <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
        ...
        <div class="md:w-8/12 lg:w-5/12 lg:ml-20 ">
          <h1 class=" text-3xl font-mono text-center rounded font-extrabold py-4 w-3/4 bg-red-300 mb-7"> ARM
            WORKOUTS</h1>

          <div>
            <p class="w-5/6 font-serif leading-10  "> It is a long established fact that a reader will be distracted
              by
...
<section class="bg-sky-100 rounded-t-3xl w-full h-full px-16 py-6 md:col-span-2  ">
  ...
  <div class="flex justify-center py-8">
    <h1 class="text-3xl font-extrabold pt-8 font-mono ">ARM WORKOUT VARIATION</h1>
  ...
  <div class="mt-8 pb-24 ">
    ...
    <nuxt-link to="/cardio">
      <div
        ...
        <div class=" flex justify-between">
          <div class="text-white ml-4 text-xl font-extrabold font-mono ">One Leg Squat</div>
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-8 h-8 fill-white mr-8">
              <path
                d="M500.5 231.4l-192-160C287.9 54.3 256 68.6 256 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2zm-256 0l-192-160C31.9 54.3 0 68.6 0 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2z" />
    ...
    <nuxt-link to="/LegPresses">
      <div
        ...
        <div class=" flex justify-between">
          <div class="text-white ml-4 text-xl font-extrabold font-mono ">Leg Extension</div>
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-8 h-8 fill-white mr-8">
              <path
                d="M500.5 231.4l-192-160C287.9 54.3 256 68.6 256 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2zm-256 0l-192-160C31.9 54.3 0 68.6 0 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2z" />
