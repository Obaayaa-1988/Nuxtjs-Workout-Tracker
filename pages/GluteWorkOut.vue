  ...
  <div>
    <div
      ...
      <div class="flex justify-around">
        ...
        <div>
          <img src="images/glutes.png" alt="PanCake" class="w-80 h-80 object-cover" />
        </div>
      </div>
    </div>
      ...
      <div class="mt-8 pb-24 ">
        <nuxt-link to="/OneLegSquat">
          <div
            ...
            <div class="flex justify-between">
              <div class=" ml-4 text-xl font-extrabold font-mono text-white"> Romanain Squat</div>
        ...
        <nuxt-link to="/cardio">
          <div
            ...
            <div class=" flex justify-between">
              <div class="text-white ml-4 text-xl font-extrabold font-mono ">DeadLifts</div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-8 h-8 fill-white mr-8">
                  <path
                    d="M500.5 231.4l-192-160C287.9 54.3 256 68.6 256 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2zm-256 0l-192-160C31.9 54.3 0 68.6 0 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2z" />
        ...
        <nuxt-link to="/LegPresses">
          <div
            ...
            <div class=" flex justify-between">
              <div class="text-white ml-4 text-xl font-extrabold font-mono ">Sumo Squats</div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-8 h-8 fill-white mr-8">
                  <path
                    d="M500.5 231.4l-192-160C287.9 54.3 256 68.6 256 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2zm-256 0l-192-160C31.9 54.3 0 68.6 0 96v320c0 27.4 31.9 41.8 52.5 24.6l192-160c15.3-12.8 15.3-36.4 0-49.2z" />
