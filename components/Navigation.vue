            ...
            <div class="flex flex-col items-center gap-y-12 mt-8">
               <p class="w-24  pr-8">
                  <nuxt-link to="/profile" class="flex justify-between gap-4">
                     <span class="text-lg font-semibold font-mono text-pink-500">Profile</span>
                     <span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                           class="w-7 h-7 font-semibold text-pink-500">
               ...
               <p class="w-24 pr-2 ">
                  <nuxt-link to="/notify" class="flex justify-between gap-4">
                     <span class="text-lg font-semibold font-mono text-pink-500">Notify</span>
                     <span>
               ...
               <p class="w-24 pr-2 ">
                  <nuxt-link to="/settings" class="flex justify-between gap-4 cursor-pointer">
                     <span class="text-lg font-semibold font-mono text-blue-500">Settings</span>
                     <span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                           class="w-6 h-6 text-blue-500">
                           <path stroke-linecap="round" stroke-linejoin="round"
